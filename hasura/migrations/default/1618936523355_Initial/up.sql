...
ALTER TABLE ONLY public.chat2
    ADD CONSTRAINT chat2_pkey PRIMARY KEY (id);
ALTER TABLE ONLY public.chat3
    ADD CONSTRAINT chat3_pkey PRIMARY KEY (id);
...
CREATE TRIGGER set_public_chat2_updated_at BEFORE UPDATE ON public.chat2 FOR EACH ROW EXECUTE FUNCTION public.set_current_timestamp_updated_at();
COMMENT ON TRIGGER set_public_chat2_updated_at ON public.chat2 IS 'trigger to set value of column "updated_at" to current timestamp on row update';
CREATE TRIGGER set_public_chat3_updated_at BEFORE UPDATE ON public.chat3 FOR EACH ROW EXECUTE FUNCTION public.set_current_timestamp_updated_at();
COMMENT ON TRIGGER set_public_chat3_updated_at ON public.chat3 IS 'trigger to set value of column "updated_at" to current timestamp on row update';
