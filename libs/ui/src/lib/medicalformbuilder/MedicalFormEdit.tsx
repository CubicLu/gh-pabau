...
const medicalForms = [
  ...
  { id: 17, formType: 'basic', formName: 'basic_snomed' },
  { id: 18, formType: 'custom', formName: 'custom_emailmarketing' },
  { id: 19, formType: 'custom', formName: 'custom_smsmarketing' },
  { id: 20, formType: 'custom', formName: 'custom_phonecall' },
  { id: 21, formType: 'custom', formName: 'custom_lettermarketing' },
  { id: 22, formType: 'custom', formName: 'custom_membershipnumber' },
  { id: 23, formType: 'custom', formName: 'custom_authorizationcode' },
  { id: 24, formType: 'custom', formName: 'custom_company' },
  { id: 25, formType: 'custom', formName: 'custom_dob' },
  { id: 26, formType: 'custom', formName: 'custom_gender' },
  { id: 27, formType: 'custom', formName: 'custom_physicaladdress' },
  { id: 28, formType: 'custom', formName: 'custom_referredby' },
  { id: 29, formType: 'custom', formName: 'custom_telephonenumber' },
]
