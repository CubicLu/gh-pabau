...
const VerifyNumberCall: FC<VerifyNumberProps> = ({
  changeScreen,
  phoneValue,
}) => {
  ...
  return (
    <div>
      <div className={styles.verifyCallContainer}>
        ...
        <div className={styles.enterNumberInfo}>
          <p>
            ...
            this call to hear a message that includes your verification code. be
            prepared to write down the number.
          </p>
          <label>
...
export default VerifyNumberCall
