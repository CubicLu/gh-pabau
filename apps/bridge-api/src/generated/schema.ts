...
export interface Company {
  ...
  ManageCustomField?: ManageCustomField[];
  ManageCustomFieldCategory?: ManageCustomFieldCategory[];
  ManageCustomFieldItem?: ManageCustomFieldItem[];
  TblModuleFieldsSetting?: TblModuleFieldsSetting[];
  CmContactCustom?: CmContactCustom[];
  CmLabel?: CmLabel[];
  CmContactLabel?: CmContactLabel[];
...
export interface CmContactLabel {
  id: number;
  company_id: number;
  contact_id: number;
  label_id: number;
...
export interface CmContactCustom {
  id: number;
  contact_id: number;
  company_id: number;
  custom_field_id: number;
...
export interface ManageCustomField {
  id: number;
  field_label?: string;
  field_type?: string;
  company_id?: number;
  ...
  User?: User;
  Location?: CompanyBranch;
  CmFields?: ManageCustomFieldCategory;
  ManageCustomFieldItem?: ManageCustomFieldItem[];
  CmContactCustom?: CmContactCustom[];
}

export interface ManageCustomFieldCategory {
  id: number;
  name: string;
  company_id: number;
  Company: Company;
  CmFields?: ManageCustomField[];
}

export interface ManageCustomFieldItem {
  id: number;
  field_id?: number;
  company_id?: number;
  item_label: string;
...
export interface TblModuleFieldsSetting {
  id: number;
  module_id?: number;
  field_name?: string;
  field_label?: string;
