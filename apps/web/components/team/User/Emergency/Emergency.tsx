...
const Emergency = () => {
  ...
  const DoctorJsx: FC<DoctorProps> = ({ setFieldValue }) => {
    return (
      <div
        className={classNames(
          styles.doctorWrapper,
          isMobile && styles.doctorMobileWrapper
        )}
      >
        ...
        <Form layout="vertical">
          <div className={styles.emergencyMainWrapper}>
            ...
            <div className={styles.upperWrapper}>
              ...
              {!isMobile && <DoctorJsx setFieldValue={setFieldValue} />}
            </div>
            ...
            {isMobile && <DoctorJsx setFieldValue={setFieldValue} />}
            {isMobile && (
              <div className={styles.emergencyHeadMobileBtn}>
                <Button
                  size={'large'}
                  htmlType={'submit'}
                  className={styles.saveBtn}
