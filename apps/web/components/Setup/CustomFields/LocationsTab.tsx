...
import {
  useGetLocationsCustomFieldsLeadDataLazyQuery,
...
import { locationsData as staticData } from './data.js'
...
export const LocationsTab: FC<LocationsTabProps> = ({
  paginateData = {
    total: 0,
    offset: 0,
    limit: 100,
    ...
    <>
      ...
      {selectedItem && (
        <CreateCustomFieldModal
          visible={true}
          selectedAttributeLabel={'locations'}
          modalTitle={'Edit Locations'}
          onClose={() => {
