  ...
  profile: {
    ...
    widgets: [
      ...
      },
      {
        ...
        isEnabled: false,
        title: 'Invoices',
        description: 'Clients can view their lab results online.',
      },
      {
        id: 3,
        ...
        title: 'Make Payment',
        description:
          'Clients can make a flat rate payment amount against there account',
      },
      {
        id: 4,
        icon: <ShoppingOutlined />,
        ...
        title: 'My Packages',
        description:
          'Clients can see how many courses or packages they have left.',
      },
      {
        id: 5,
        icon: <TagsOutlined />,
