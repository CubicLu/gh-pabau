...
const LIST_AGGREGATE_QUERY = gql`
  query cancellation_reasons_aggregate($isActive: Boolean = true) {
    cancellation_reasons_aggregate(where: { is_active: { _eq: $isActive } }) {
      aggregate {
        count
      }
    }
...
const schema: Schema = {
  ...
  createButtonLabel: 'New Cancellation Reason',
  messages: {
    create: {
      success: 'You have successfully created cancellation reasons.',
      error: 'While creating cancellation reasons.',
    },
    update: {
      success: 'You have successfully updated cancellation reasons.',
      error: 'While updating cancellation reasons.',
    },
    delete: {
      success: 'You have successfully deleted cancellation reasons.',
